...
namespace ListaDeTarefas.Infra.Migrations
{
    ...
    [Migration("20230909102158_AdicionandoDataEntregaTarefa")]
    partial class AdicionandoDataEntregaTarefa
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ListaDeTarefas.Domain.Models.Tarefa", b =>
                {
                    b.HasOne("ListaDeTarefas.Domain.Models.Usuario", "Usuario")
                        .WithOne()
                        .HasForeignKey("ListaDeTarefas.Domain.Models.Tarefa", "FkUsuario")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ListaDeTarefas.Domain.Models.Usuario", null)
                        .WithMany("Tarefas")
